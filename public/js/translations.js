export const translations = {
    en: {
        ...
        story_detail_title_no_story: "Result Explorer",
        loading_stories: "Loading stories...",
        loading_characters: "Loading characters...",
        loading_results: "Loading results...",
        no_character_data: "No character data found.",
        error_loading_character: "Error loading character data.",
        error_loading_results: "Error loading results.",
        no_stories_found: "No story found in the list.",
        incomplete_config: "Incomplete configuration.",
        loading_images: "Loading images...",
        no_shots_defined: "No shots defined for the current story.",
        select_config_load_images: "Select configuration to load images."
    },
    zh: {
        site_title: "Storytelling Benchmark",
        nav_overview: "概览",
        ...
        story_detail_title_no_story: "结果浏览器",
        loading_stories: "加载故事中...",
        loading_characters: "加载角色中...",
        loading_results: "加载结果中...",
        no_character_data: "未找到角色数据。",
        error_loading_character: "加载角色数据出错。",
        error_loading_results: "加载结果出错。",
        no_stories_found: "未在清单中找到故事。",
        incomplete_config: "配置不完整。",
        loading_images: "加载图片中...",
        no_shots_defined: "当前故事未定义镜头。",
        select_config_load_images: "选择配置加载图片。",
        select_story_title: "选择故事：",
        prev_page: "上一页",
        next_page: "下一页",
        script_plot: "剧情对应",
        script_setting: "场景描述",
